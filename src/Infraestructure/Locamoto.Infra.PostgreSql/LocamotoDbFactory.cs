    ...
    public class LocamotoDbFactory: IDesignTimeDbContextFactory<LocamotoEFContext>
{
    public LocamotoEFContext CreateDbContext(string[] args)
    {
        ...
        optionBuilder.UseNpgsql("Server=localhost;Port=5432;User Id=postgres;Password=123456;Database=locamoto;", a => a.MigrationsAssembly("Locamoto.Infra.PostgreSql"));
